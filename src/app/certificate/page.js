...
export default function Certificate() {
  ...
  const generatePDF = () => {
    ...
    bgImg.onload = () => {
      ...
      doc.text(
        `This is to certify that ${studentName} has successfully completed the Full JavaScript Course (Levels 1–9) with unparalleled dedication, extraordinary proficiency, and exceptional skill. Through this rigorous program, ${studentName} has mastered core and advanced JavaScript concepts, including syntax, DOM manipulation, asynchronous programming, modern frameworks, and building dynamic web applications. `,
        148,
        100,
